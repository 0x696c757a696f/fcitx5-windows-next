...
impl ConfigSnapshot {
    /// Returns the exact configuration format version of this resolved snapshot.
    #[must_use]
    pub fn format_version(&self) -> u32 {
        self.format_version
    }

    /// Returns the configured UI settings.
    #[must_use]
...
impl UiConfig {
    /// Returns the configured UI language.
    #[must_use]
...
impl CandidateConfig {
    ...
    /// Returns the configured candidate opacity.
    #[must_use]
    pub fn opacity(&self) -> f32 {
        self.opacity
    }

    /// Returns the resolved candidate geometry.
    #[must_use]
    pub fn geometry(&self) -> &CandidateGeometry {
        &self.geometry
    }

    /// Returns the resolved candidate-label presentation.
    #[must_use]
    pub fn label(&self) -> &CandidateLabel {
        &self.label
    }

    /// Returns the resolved candidate colors keyed by stable color name.
    #[must_use]
...
impl CandidateGeometry {
    /// Returns horizontal panel padding in DIP.
    #[must_use]
    pub fn padding_x_dip(&self) -> f32 {
        self.padding_x_dip
    }

    /// Returns vertical panel padding in DIP.
    #[must_use]
    pub fn padding_y_dip(&self) -> f32 {
        self.padding_y_dip
    }

    /// Returns horizontal item padding in DIP.
    #[must_use]
    pub fn item_padding_x_dip(&self) -> f32 {
        self.item_padding_x_dip
    }

    /// Returns vertical item padding in DIP.
    #[must_use]
    pub fn item_padding_y_dip(&self) -> f32 {
        self.item_padding_y_dip
    }

    /// Returns row spacing in DIP.
    #[must_use]
    pub fn row_gap_dip(&self) -> f32 {
        self.row_gap_dip
    }

    /// Returns column spacing in DIP.
    #[must_use]
    pub fn column_gap_dip(&self) -> f32 {
        self.column_gap_dip
    }

    /// Returns border width in DIP.
    #[must_use]
    pub fn border_width_dip(&self) -> f32 {
        self.border_width_dip
    }

    /// Returns corner radius in DIP.
    #[must_use]
    pub fn corner_radius_dip(&self) -> f32 {
        self.corner_radius_dip
    }

    /// Returns whether the candidate panel uses a shadow.
    #[must_use]
...
impl CandidateLabel {
    ...
    /// Returns labels in slot order.
    #[must_use]
    pub fn sequence(&self) -> &[String] {
        &self.sequence
    }

    /// Returns the label font scale.
    #[must_use]
    pub fn font_scale(&self) -> f32 {
        self.font_scale
    }

    /// Returns the label gap in DIP.
    #[must_use]
    pub fn gap_dip(&self) -> f32 {
        self.gap_dip
    }
}
...
impl FontsConfig {
    /// Returns UI font fallback settings.
    #[must_use]
    pub fn ui(&self) -> &FontFamilies {
        &self.ui
    }
    ...
    /// Returns annotation font settings.
    #[must_use]
    pub fn annotation(&self) -> &AnnotationFont {
        &self.annotation
    }

    /// Returns monospace font fallback settings.
    #[must_use]
    pub fn monospace(&self) -> &FontFamilies {
        &self.monospace
    }
}
...
impl FontFamilies {
    /// Returns font fallbacks in priority order.
    #[must_use]
...
impl CandidateFont {
    ...
    /// Returns the candidate font weight.
    #[must_use]
...
impl AnnotationFont {
    /// Returns annotation font fallbacks in priority order.
    #[must_use]
    pub fn families(&self) -> &[String] {
        &self.families
    }

    /// Returns annotation size relative to the candidate font.
    #[must_use]
