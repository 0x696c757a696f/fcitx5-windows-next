...
int main(int argc, char** argv) {
    ...
    if (runtimeSecurityScript.find("Join-Path $repoRoot 'rust'") == std::string::npos ||
        ...
        runtimeSecurityScript.find("CreateRemoteThread") == std::string::npos ||
        runtimeSecurityScript.find("VirtualAllocEx") == std::string::npos) {
        return fail("RUNTIME-SECURITY-RUST-SCAN: runtime security source scan must cover Rust and prohibited input/injection APIs");
    }
    ...
    if (runtimeSource.find("std::uint64_t nextCompositionId{1}") != std::string::npos ||
        ...
        runtimeSource.find("std::unordered_map<ClientContextKey, protocol::CaretRect") !=
            std::string::npos ||
        runtimeSource.find("popupAllowed;") != std::string::npos ||
        runtimeSource.find("selectedOverride;") != std::string::npos ||
        runtimeSource.find("inputMethodOverridden;") != std::string::npos ||
    ...
    if (launcherSource.find("GetModuleFileNameW") != std::string::npos ||
        ...
        return fail("LAUNCHER-RUNTIME-PATHS-RUST: Launcher runtime paths must be Rust-owned");
    }
    ...
    if (controlSource.find("MultiByteToWideChar") != std::string::npos ||
        ...
        controlSource.find("MoveFileExW(") != std::string::npos ||
        controlSource.find("FILE_FLAG_WRITE_THROUGH") != std::string::npos ||
        controlSource.find("MOVEFILE_REPLACE_EXISTING") != std::string::npos ||
        controlSource.find("MOVEFILE_WRITE_THROUGH") != std::string::npos ||
        ...
        controlSource.find("fcitx5_control_read_optional_config_utf16") ==
            std::string::npos ||
        ...
        controlSource.find("fcitx5_control_package_architecture_matches_native_utf8") ==
            std::string::npos ||
        controlSource.find("fcitx5_control_addon_metadata_section_is_addon_utf8") ==
            std::string::npos ||
        controlSource.find("fcitx5_control_addon_metadata_key_utf8") == std::string::npos ||
        controlSource.find("fcitx5_control_addon_metadata_bool_utf8") == std::string::npos ||
        ...
        controlSource.find("fcitx5_control_package_state_satisfies_dependency_utf8") ==
            std::string::npos ||
        controlSource.find("fcitx5_control_package_state_keeps_installed_version_utf8") ==
            std::string::npos ||
        controlSource.find("fcitx5_control_repository_max_release_sequence") ==
            std::string::npos ||
        controlSource.find("fcitx5_control_repository_metadata_url_utf16") ==
            std::string::npos ||
        controlSource.find("fcitx5_control_repository_default_base_url_utf16") ==
            std::string::npos ||
        controlSource.find("fcitx5_control_package_transaction_id_utf8") ==
            std::string::npos ||
        ...
        controlSource.find("fcitx5_control_repository_cache_publish_utf16") ==
            std::string::npos ||
        controlSource.find("fcitx5_control_package_archive_cache_path_utf16") ==
            std::string::npos ||
        controlSource.find("fcitx5_control_package_archive_cache_prepare_utf16") ==
            std::string::npos ||
        controlSource.find("fs::create_directories(downloads)") != std::string::npos ||
        controlSource.find("fs::remove(archive") != std::string::npos ||
        controlSource.find("widen(entry->id + \"-\" + entry->version + \".fcpkg\")") !=
            std::string::npos ||
        ...
        controlSource.find("repositoryError == \"invalid_file\"") != std::string::npos ||
        ...
        controlSource.find("found->second.version != entry.version") != std::string::npos ||
        controlSource.find("active->version != repositoryEntry->version") !=
            std::string::npos ||
        controlSource.find("item.state != \"disabled\"") != std::string::npos ||
        controlSource.find("item.state != \"pending_remove\"") != std::string::npos ||
        controlSource.find("item.state != \"broken\"") != std::string::npos ||
        controlSource.find("item.state != \"quarantined\"") != std::string::npos ||
        controlSource.find("indexMaxSequence") != std::string::npos ||
        controlSource.find("std::max(maximum, entry.release_sequence)") != std::string::npos ||
        controlSource.find("baseUrl.pop_back()") != std::string::npos ||
        controlSource.find("baseUrl + L\"/index.json\"") != std::string::npos ||
        ...
        controlSource.find("entry.architecture != \"any\"") != std::string::npos ||
        ...
        rustControlCoreSource.find("fcitx5_control_read_optional_config_utf16") ==
            std::string::npos ||
        ...
        rustControlCoreSource.find("fcitx5_control_native_package_architecture_utf8") ==
            std::string::npos ||
        rustControlCoreSource.find("fcitx5_control_package_architecture_matches_native_utf8") ==
            std::string::npos ||
        rustControlCoreSource.find("fcitx5_control_addon_metadata_section_is_addon_utf8") ==
            std::string::npos ||
        rustControlCoreSource.find("fcitx5_control_addon_metadata_key_utf8") ==
            std::string::npos ||
        rustControlCoreSource.find("fcitx5_control_addon_metadata_bool_utf8") ==
            std::string::npos ||
        rustControlCoreSource.find("fcitx5_control_package_update_available_utf8") ==
            std::string::npos ||
        rustControlCoreSource.find("fcitx5_control_package_state_satisfies_dependency_utf8") ==
            std::string::npos ||
        rustControlCoreSource.find("fcitx5_control_package_state_keeps_installed_version_utf8") ==
            std::string::npos ||
        rustControlCoreSource.find("fcitx5_control_repository_max_release_sequence") ==
            std::string::npos ||
        rustControlCoreSource.find("fcitx5_control_repository_metadata_url_utf16") ==
            std::string::npos ||
        rustControlCoreSource.find("fcitx5_control_repository_default_base_url_utf16") ==
            std::string::npos ||
        rustControlCoreSource.find("fcitx5_control_package_transaction_id_utf8") ==
            std::string::npos ||
        rustControlCoreSource.find("fcitx5_control_repository_cache_prepare_utf16") ==
            std::string::npos ||
        rustControlCoreSource.find("fcitx5_control_repository_cache_publish_utf16") ==
            std::string::npos ||
        rustControlCoreSource.find("fcitx5_control_package_archive_cache_path_utf16") ==
            std::string::npos ||
        rustControlCoreSource.find("fcitx5_control_package_archive_cache_prepare_utf16") ==
            std::string::npos ||
        ...
        rustControlCoreSource.find("bounded_file_read_matches_cpp_contract") ==
            std::string::npos ||
        rustControlCoreSource.find("optional_config_read_matches_cpp_contract") ==
            std::string::npos ||
        ...
        rustControlCoreSource.find("package_architecture_match_matches_cpp_contract") ==
            std::string::npos ||
        rustControlCoreSource.find("addon_metadata_vocabulary_matches_cpp_contract") ==
            std::string::npos ||
        rustControlCoreSource.find("addon_metadata_bool_matches_cpp_contract") ==
            std::string::npos ||
        ...
        rustControlCoreSource.find("package_lifecycle_state_policy_matches_cpp_contract") ==
            std::string::npos ||
        rustControlCoreSource.find("repository_max_release_sequence_matches_cpp_contract") ==
            std::string::npos ||
        rustControlCoreSource.find("repository_metadata_url_matches_cpp_contract") ==
            std::string::npos ||
        rustControlCoreSource.find("repository_default_base_url_matches_cpp_contract") ==
            std::string::npos ||
        rustControlCoreSource.find("package_transaction_id_matches_cpp_contract") ==
            std::string::npos ||
        ...
        rustControlCoreSource.find("CONTROL_FILE_READ_MISSING") == std::string::npos ||
        rustControlCoreSource.find("CONTROL_ARCHIVE_CACHE_STALE_REMOVED") == std::string::npos ||
    ...
    if (peerSource.find("pathsReferToSameFile") != std::string::npos ||
        ...
        peerSource.find("queryProcessIdentity") != std::string::npos ||
        peerSource.find("GetNamedPipeServerProcessId") != std::string::npos ||
        peerSource.find("GetNamedPipeClientProcessId") != std::string::npos ||
        ...
        peerSource.find("fcitx5_windows_common_verify_pipe_server_peer_utf16") ==
            std::string::npos ||
        peerSource.find("fcitx5_windows_common_verify_pipe_client_peer_utf16") ==
            std::string::npos) {
    ...
    if (pipeClientSource.find("response.metadata.responseTo != requestId") !=
        ...
        pipeClientSource.find("result = std::move(response)") != std::string::npos ||
        ...
        pipeClientSource.find("fcitx5_windows_common_accept_engine_status_response") !=
            std::string::npos ||
        pipeClientSource.find("fcitx5_windows_common_apply_engine_status_response_scalars") ==
            std::string::npos) {
    ...
    if (std::filesystem::exists(sourceRoot / "src/common/version.cpp") ||
        ...
        rustWindowsCommonCore.find("local_endpoint_and_object_names_match_cpp_contract") ==
            std::string::npos ||
        rustWindowsCommonCore.find("fcitx5_windows_common_local_test_namespace_utf16") ==
            std::string::npos ||
        rustWindowsCommonCore.find("local_test_namespace_matches_cpp_contract") ==
            std::string::npos ||
        rustWindowsCommonCore.find("fcitx5_windows_common_current_generation_utf16") ==
            std::string::npos ||
        ...
        rustWindowsCommonCore.find("process_session_id_query_matches_cpp_contract") ==
            std::string::npos ||
        rustWindowsCommonCore.find("fcitx5_windows_common_process_user_sid_utf16") ==
            std::string::npos ||
        ...
        rustWindowsCommonCore.find("fcitx5_windows_common_pipe_security_descriptor_utf16") ==
            std::string::npos ||
        rustWindowsCommonCore.find("fcitx5_windows_common_pipe_security_create_utf16") ==
            std::string::npos ||
        rustWindowsCommonCore.find("fcitx5_windows_common_pipe_security_attributes") ==
            std::string::npos ||
        rustWindowsCommonCore.find("fcitx5_windows_common_pipe_security_destroy") ==
            std::string::npos ||
        ...
        rustWindowsCommonCore.find("pipe_security_sddl_matches_cpp_contract") ==
            std::string::npos ||
        rustWindowsCommonCore.find("pipe_security_state_matches_cpp_attributes_contract") ==
            std::string::npos ||
        ...
        rustWindowsCommonCore.find("fcitx5_windows_common_accept_engine_status_response") ==
            std::string::npos ||
        rustWindowsCommonCore.find("fcitx5_windows_common_apply_engine_status_response_scalars") ==
            std::string::npos ||
        ...
        rustWindowsCommonCore.find("fcitx5_windows_common_verify_pipe_client_peer_utf16") ==
            std::string::npos ||
        rustWindowsCommonCore.find("pipe_client_peer_policy_rejects_invalid_pipe_like_cpp_contract") ==
            std::string::npos ||
        rustWindowsCommonCore.find("GetNamedPipeClientProcessId") == std::string::npos ||
        ...
        pipeSecuritySource.find("identity.userSid.empty() || identity.serviceAccount") !=
            std::string::npos ||
        pipeSecuritySource.find("fcitx5_windows_common_pipe_security_create_utf16") ==
            std::string::npos ||
        pipeSecuritySource.find("fcitx5_windows_common_pipe_security_attributes") ==
            std::string::npos ||
        pipeSecuritySource.find("fcitx5_windows_common_pipe_security_destroy") ==
            std::string::npos ||
        ...
        pipeSecuritySource.find("LocalFree") != std::string::npos ||
        pipeSecuritySource.find("lpSecurityDescriptor") != std::string::npos ||
        pipeSecuritySource.find("bInheritHandle") != std::string::npos ||
        pipeSecuritySource.find("nLength = sizeof(SECURITY_ATTRIBUTES)") !=
            std::string::npos ||
        ...
        runtimeIdentitySource.find("OpenProcessToken") != std::string::npos ||
        runtimeIdentitySource.find("GetTokenInformation") != std::string::npos ||
        runtimeIdentitySource.find("ConvertSidToStringSidW") != std::string::npos ||
        runtimeIdentitySource.find("IsWellKnownSid") != std::string::npos ||
        runtimeIdentitySource.find("LocalFree") != std::string::npos ||
        ...
        runtimeIdentitySource.find("kReleaseIdentity.local_object_prefix") !=
            std::string::npos ||
        runtimeIdentitySource.find("sameFinalPath") != std::string::npos ||
    ...
    if (rustToolchain.find("channel = \"1.98.0\"") == std::string::npos ||
        ...
        packageSource.find("BCryptHashData") != std::string::npos ||
        packageSource.find("blake3_hasher") != std::string::npos ||
    ...
    if (configSource.find("struct DesignTokens") == std::string::npos ||
        ...
        candidateUiSource.find("resources\" / L\"themes\" / L\"default\"") !=
            std::string::npos ||
        candidateUiSource.find("data / L\"themes\"") != std::string::npos ||
