...
**State:** MANUAL-PENDING / STAGE2-RUST-CONFIG-BACKEND-SHIPPED-GREEN / SHIPPING-RUST-CONFIG-EXE-GREEN / PACKAGE-CONFIG-SMOKE-GREEN / SIDE-BY-SIDE-DIFFERENTIAL-GREEN / RUST-SETTINGS-UI-PREVIEW-QA-GREEN / RUST-CANDIDATE-PREVIEW-FIDELITY-QA-GREEN / RUST-NUMERIC-APPEARANCE-QA-GREEN / RUST-SYSTEM-FONT-PICKER-QA-GREEN / RUST-FONT-PERSISTENCE-RESTART-QA-GREEN / RUST-ADVANCED-NUMERIC-APPEARANCE-QA-GREEN / RUST-PAGE-VISIBILITY-INPUTMETHODS-QA-GREEN / RUST-LANGUAGE-SELECTOR-QA-GREEN / RUST-PACKAGE-PLUGIN-PAGE-QA-GREEN / RUST-KEYBOARD-TABSTOP-QA-GREEN / STAGE4-REAL-HOST-EVIDENCE-PENDING / PACKAGE-GATE-ENGINE-IDLE-FIXED-BY-050 / WINDUI-DEFAULT-SHELL-CLOSED-BY-058

**Current supersession note:** the Engine idle package gate blocker recorded
during this task was fixed by `050`, and the default interactive Config shell
was moved to vendored `wind-ui-rust` by `058`. Release readiness still depends
on manual/real-host and production signing/package evidence.
