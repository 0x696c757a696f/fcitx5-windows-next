...
| `tests/integration/fcitx_engine_integration_test.cpp` | KEEP | Engine IPC mixed integration | Final engine/IPC integration through the native adapter | `CMakeLists.txt:1617-1621`; retained as final mixed integration target |
| `tests/integration/ipc_generation_routing_test.cpp` | KEEP | Named-pipe generation routing integration | Necessary Win32 IPC plus mixed engine boundary | `CMakeLists.txt:1516-1523`; retained as `ipc-generation-routing` |
| `tests/integration/ipc_idle_client_test.cpp` | KEEP | Named-pipe idle-client integration | Necessary Win32 IPC adapter boundary | `CMakeLists.txt:1508-1514`; retained as `ipc-idle-client` |
| `tests/integration/ipc_late_response_test.cpp` | KEEP | Reconnect/late-response integration | Necessary Win32 IPC adapter and mixed engine boundary | `CMakeLists.txt:1525-1532`; retained as `ipc-late-response-reconnect` |
| `tests/integration/ipc_multi_client_test.cpp` | KEEP | Multi-client IPC integration | Necessary Win32 IPC adapter and x64/x86 mixed boundary | `CMakeLists.txt:1498-1506`; retained as `ipc-multi-client` and `ipc-multi-client-32` |
| `tests/integration/ipc_roundtrip_test.cpp` | KEEP | Pipe client/engine roundtrip integration | Necessary Win32 IPC adapter plus final mixed engine boundary | `CMakeLists.txt:1491-1496`; retained as `ipc-key-commit-roundtrip` |
...
| `fcitx5_ipc_roundtrip_test` / `ipc-key-commit-roundtrip` | KEEP | Final mixed engine/IPC integration | Retained Win32 IPC boundary | `CMakeLists.txt:1491-1496` |
| `fcitx5_ipc_multi_client_test` / `ipc-multi-client`, `ipc-multi-client-32` | KEEP | Win32 IPC multi-client integration | Retained x64/x86 boundary | `CMakeLists.txt:1498-1506` |
| `fcitx5_ipc_idle_client_test` / `ipc-idle-client` | KEEP | Win32 IPC adapter integration | Retained boundary | `CMakeLists.txt:1508-1514` |
| `fcitx5_ipc_generation_routing_test` / `ipc-generation-routing` | KEEP | Generation-aware IPC integration | Retained boundary | `CMakeLists.txt:1516-1523` |
| `fcitx5_ipc_late_response_test` / `ipc-late-response-reconnect` | KEEP | IPC reconnect integration | Retained boundary | `CMakeLists.txt:1525-1532` |
...
| `fcitx5_engine_integration_test` | KEEP | Final Engine integration executable | Retained mixed boundary | `CMakeLists.txt:1617-1621` |
