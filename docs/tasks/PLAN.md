...
| R3-01 | RUST-R3-CANDIDATE-POC | MANUAL-PENDING / AUTOMATED-POC-GREEN / CONFIG-EMBEDDED-EMOJI-PREVIEW-GREEN / CANDIDATE-MODEL-RUST-CUTOVER-GREEN | Candidate UX/layout/UILess contracts frozen; R1/R2 not blocked; user explicitly opened R3 gate; candidate model semantics are Rust-owned and old C++ model source is deleted | completed/RUST-R3-CANDIDATE-POC.md |
