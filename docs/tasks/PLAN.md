...
| 069 | PLUGIN-ECOSYSTEM-BUILD-MATRIX-001 | SELECTED / CODE-ONLY / EXTERNAL-EVIDENCE-PARTIAL | 067 provenance and 068 freshness contracts green; add Lua and one non-Chinese upstream addon as real pinned build/package/sign-input/install/load slices after the existing Rime production-input path | 069-PLUGIN-ECOSYSTEM-BUILD-MATRIX-001.md |
