...
| R3-01 | RUST-R3-CANDIDATE-POC | MANUAL-PENDING / AUTOMATED-POC-GREEN / CONFIG-EMBEDDED-EMOJI-PREVIEW-GREEN / CANDIDATE-MODEL-RUST-CUTOVER-GREEN / CANDIDATE-INTERACTION-RUST-CUTOVER-GREEN / CANDIDATE-INTERACTION-HEADER-DELETED / CANDIDATE-LAYOUT-RUST-CUTOVER-GREEN | Candidate UX/layout/UILess contracts frozen; R1/R2 not blocked; user explicitly opened R3 gate; candidate model, interaction, and layout/render-segment semantics are Rust-owned and old C++ sources are deleted | completed/RUST-R3-CANDIDATE-POC.md |
