...
| R3-01 | RUST-R3-CANDIDATE-POC | CURRENT / HEADLESS-POC-GREEN / WINDOW-A11Y-VISUAL-SMOKE-GREEN / UIA-SMOKE-GREEN / DEMO-DIFFERENTIAL-GREEN / SCROLL-DEMO-DIFFERENTIAL-GREEN / CPP-VISUAL-SNAPSHOT-GREEN / CONFIG-EMBEDDED-PREVIEW-GREEN / CONFIG-THEME-FIDELITY-GREEN / CONFIG-PREVIEW-QA-GREEN / DPI-WINDOW-SMOKE-GREEN / GUI-DIFFERENTIAL-PENDING | Candidate UX/layout/UILess contracts frozen; R1/R2 not blocked; user explicitly opened R3 gate | current.md |
