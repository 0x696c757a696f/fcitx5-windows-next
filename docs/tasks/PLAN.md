...
| 067 | PLUGIN-PROVENANCE-DATA-BOUNDARY-001 | SELECTED / CODE-ONLY | 065 and existing signed v2 package path; freeze/implement runtime ABI/build/source provenance and durable user-data/version-directory separation | 067-PLUGIN-PROVENANCE-DATA-BOUNDARY-001.md |
