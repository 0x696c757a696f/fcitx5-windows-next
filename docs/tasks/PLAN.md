...
| 070 | LOW-RESOURCE-SLO-CALIBRATION-001 | SELECTED / CODE-ONLY / EXTERNAL-EVIDENCE-PARTIAL | 066 semantics, 068 repository path, and 069 ecosystem matrix green; add repeatable low-resource measurement harness and initial SLO evidence, leaving real 2-core/4-GB calibration manual-pending | 070-LOW-RESOURCE-SLO-CALIBRATION-001.md |
