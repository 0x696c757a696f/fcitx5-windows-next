...
| 073 | FCITX-UPSTREAM-REBASELINE-BUILD-001 | TODO / EXTERNAL-EVIDENCE-PARTIAL | 2026-08-28 official `fcitx/fcitx5` cdd0b9d pin and patch audit green; requires the pinned MSYS2/CLANG64 toolchain to configure/build native-engine and complete shipping/host evidence before promotion | 073-FCITX-UPSTREAM-REBASELINE-BUILD-001.md |
| 074 | RELEASE-HOST-EVIDENCE-AND-SIGNING-UAC-001 | TODO / EXTERNAL-EVIDENCE | 071-073 as applicable; user-authorized Accessibility and production signing/UAC work; requires exact staged artifacts and real host/credential prerequisites | 074-RELEASE-HOST-EVIDENCE-AND-SIGNING-UAC-001.md |
