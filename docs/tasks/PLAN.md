...
| 085 | CANDIDATE-WECHAT-THEME-CONSISTENCY-001 | IN PROGRESS | 060-062 and 080-084; fixes the alpha-lost/green-on-green shipping contrast defect and aligns builtin theme, Qingfeng, renderer fallback, Settings preview, and PoC imagery without changing High Contrast or release evidence status | 085-CANDIDATE-WECHAT-THEME-CONSISTENCY-001.md |
