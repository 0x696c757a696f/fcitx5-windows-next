...
| 078 | IPC-PLATFORM-RUST-SEAM-CUTOVER-001 | SELECTED / RECLASSIFIED | 077 COMPLETED; reclassification slice done (peer_verification/pipe_security/runtime_identity provably policy-free native seams; pipe_client/launcher_client thin transport adapters gated on renderer/IPC migration); deletion acceptance still open | 078-IPC-PLATFORM-RUST-SEAM-CUTOVER-001.md |
