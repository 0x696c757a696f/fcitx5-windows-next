...
| R3-02 | RUST-R3-CONFIG-POC | CURRENT / INITIAL-POC-GREEN / VIEW-MODEL-SELF-CHECK-GREEN / LAYOUT-NONOVERLAP-SELF-CHECK-GREEN / OPERATION-STATE-MACHINE-GREEN / TYPED-BOUNDARY-CONSUMPTION-GREEN / WINDOW-SMOKE-GREEN | Settings operation model and typed Control/config/package boundaries frozen; R1/R2 not blocked | current.md |
