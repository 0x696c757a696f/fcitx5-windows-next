...
| 080 | CANDIDATE-RENDERER-RUST-CUTOVER-001 | SELECTED / FROZEN-CORPUS-STAGE-1 | 078 transport adapters deleted; last large product C++ is ui_main.cpp (2993-line D2D/DWrite candidate renderer/window adapter); semantics already Rust-owned (candidate-core), migrate renderer/window with equivalent visual/DPI golden evidence | 080-CANDIDATE-RENDERER-RUST-CUTOVER-001.md |
