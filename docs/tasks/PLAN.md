...
| 064 | CONFIG-CANDIDATE-PLUGIN-USABILITY-CORRECTION-001 | IN PROGRESS / USER-PRIORITIZED-CORRECTION | 062 + 063; restore Scroll, `N x 6`, and `6 x N` Candidate controls and close the first real signed online plugin lifecycle without weakening trust checks | 064-CONFIG-CANDIDATE-PLUGIN-USABILITY-CORRECTION-001.md |
