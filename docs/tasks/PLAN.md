...
| 048 | CONFIG-RUST-CUTOVER-001 | IN-PROGRESS / SIDE-BY-SIDE-DIFFERENTIAL-GREEN / RUST-SETTINGS-UI-PREVIEW-QA-GREEN / RUST-CANDIDATE-PREVIEW-FIDELITY-QA-GREEN / RUST-NUMERIC-APPEARANCE-QA-GREEN / RUST-SYSTEM-FONT-PICKER-QA-GREEN / RUST-FONT-PERSISTENCE-RESTART-QA-GREEN / RUST-ADVANCED-NUMERIC-APPEARANCE-QA-GREEN / RUST-PAGE-VISIBILITY-INPUTMETHODS-QA-GREEN / RUST-LANGUAGE-SELECTOR-QA-GREEN / RUST-PACKAGE-PLUGIN-PAGE-QA-GREEN / RUST-KEYBOARD-TABSTOP-QA-GREEN / REAL-CANDIDATE-PREVIEW-HOST-REQUIRED | 047 theme/preview/operation contract green; user authorized non-Engine Rust cutover; shipping Config C++ shell is temporary only | current.md |
