...
| 066 | CANDIDATE-SEMANTIC-A11Y-001 | SELECTED / CODE-ONLY | 065 contract green; CandidateModel already Rust-owned, but renderer/UIA/notification must consume one revisioned semantic source with sensitive-context suppression | 066-CANDIDATE-SEMANTIC-A11Y-001.md |
