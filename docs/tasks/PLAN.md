...
| 081C | RENDERER-HWND-RUST-001 | PARTIAL / ALL-RENDERING-THROUGH-RUST / WINDOW-PLUMBING-REMAINING | HWND creation + message loop + mouse/keyboard dispatch to Rust; delete C++ CandidateWindow | |
