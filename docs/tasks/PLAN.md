...
| R3-01 | RUST-R3-CANDIDATE-POC | CURRENT / HEADLESS-POC-GREEN / WINDOW-SMOKE-GREEN / GUI-EVIDENCE-PENDING | Candidate UX/layout/UILess contracts frozen; R1/R2 not blocked; user explicitly opened R3 gate | current.md |
