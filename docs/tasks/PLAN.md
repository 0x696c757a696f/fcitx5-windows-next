...
| 048 | CONFIG-RUST-CUTOVER-001 | IN-PROGRESS / INITIAL-CUTOVER-CORPUS-GREEN | 047 theme/preview/operation contract green; user authorized non-Engine Rust cutover; shipping Config C++ shell is temporary only | current.md |
